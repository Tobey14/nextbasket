'use client'
import { getActiveProductFromLocalStorage } from '@/utils/localstorage';
                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="transform overflow-hidden min-w-[80%] max-h-[80%] rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <section className="w-full relative">
                                        <div className="flex space-x-3 justify-center md:justify-start mb-5 px-5">
                                            <div className="w-[65%] h-fit bg-[#FFFFFF] p-3 shadow-2xl  overflow-x-hidden overflow-y-auto">
                                                    ...
                                                    return <div key={index}>
                                                        <div className="flex w-full justify-between">
                                                            <div className="min-w-[70%] flex">
                                                                <img className='w-[18%] mr-[10px]' src={data.thumbnail} alt="product-image" />
                                                                <div>
                                            ...
                                            <div className="cart-summary shadow-2xl p-3 w-[34%] h-fit">
                                                <p>Cart Summary</p>
                                                <hr />
